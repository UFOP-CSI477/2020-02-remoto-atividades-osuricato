...
<form action="{{route('registros.update', $registro->id)}}" method="post">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" name="dose" id="dose" required value="{{ $registro->dose }}">
  </div>

  <div class="form-group">
    <label for="data">Data</label>
    <input type="date" class="form-control" name="data" id="data" required value="{{ $registro->data }}">
  </div>
